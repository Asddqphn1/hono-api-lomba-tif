    ...
    try {
        ...
        const lombaFilter = lomba
            ? {
                pesertalomba: {
                    some: {
                        lomba_id: lomba, // Filter berdasarkan ID lomba
                    },
                },
            }
            : {};
        ...
        const filteredPeserta = daftarpeserta.filter((peserta) => peserta.pesertalomba.length > 0);
        return c.json({
            status: "Success",
